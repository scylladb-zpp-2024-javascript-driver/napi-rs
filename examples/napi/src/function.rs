...
#[napi]
pub fn call_function_with_arg(cb: Function<FnArgs<(u32, u32)>, u32>, arg0: u32, arg1: u32) -> Result<u32> {
...
#[napi]
pub fn build_threadsafe_function_from_function(callback: Function<FnArgs<(u32, u32)>, u32>) -> Result<()> {
